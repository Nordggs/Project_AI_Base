"""Tests: soft_stop and close_cdp handle custom1/custom2 pages.

These behavioral tests verify the code actually closes/resets custom pages,
rather than checking hardcoded lists.
"""
...
class TestSoftStopCleanup:
    """soft_stop must stop custom pages too."""

    def test_soft_stop_includes_custom_pages(self, mock_app):
        """soft_stop worker iterates custom pages."""
    ...
    def test_close_cdp_includes_custom_pages(self, mock_app):
        """close_cdp worker iterates and closes custom pages."""
        custom1_page = MagicMock()
        custom2_page = MagicMock()
        mock_app.custom1_page = custom1_page
        mock_app.custom2_page = custom2_page
    ...
    def test_close_cdp_browser_resets_custom_pages(self, mock_app):
        """_close_cdp_browser resets custom1_page and custom2_page."""
    ...
    def test_close_cdp_browser_resets_custom_connect_flags(self, mock_app):
        """_close_cdp_browser resets _custom1_connected and _custom2_connected."""
